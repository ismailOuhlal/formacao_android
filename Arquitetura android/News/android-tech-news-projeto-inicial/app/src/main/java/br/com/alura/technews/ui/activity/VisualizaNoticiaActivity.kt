...
import br.com.alura.technews.ui.viewmodel.factory.VisualizaNoticiaFactory
...
class VisualizaNoticiaActivity : AppCompatActivity() {
    ...
    private val viewModel by lazy {
        ...
        val visualizaNoticia = VisualizaNoticiaFactory(noticiaId, repository)

        ViewModelProvider(this, visualizaNoticia)[VisualizaNoticiaViewModel::class.java]
    }
