...
class ListaNoticiasActivity : AppCompatActivity() {
    ...
    private val viewModel by lazy {
        ...
        val listaNoticiaViewModelFactory = ListaNoticiaViewModelFactory(repository)

        ViewModelProvider(this, listaNoticiaViewModelFactory)[ListaNoticiasViewModel::class.java]
    }
