...
import br.com.alura.technews.ui.viewmodel.factory.FormularioActivityViewModelFactory
import br.com.alura.technews.ui.viewmodel.factory.ListaNoticiaViewModelFactory
...
class FormularioNoticiaActivity : AppCompatActivity() {
    ...
    private val viewModel by lazy {
        ...
        val listaNoticiaViewModelFactory = FormularioActivityViewModelFactory(repository)

        ViewModelProvider(this, listaNoticiaViewModelFactory)[FormularioActivityViewModel::class.java]
    }
