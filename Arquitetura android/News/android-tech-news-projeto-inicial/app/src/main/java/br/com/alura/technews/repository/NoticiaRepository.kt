...
class NoticiaRepository(
    ...
    fun buscaTodos(): LiveData<Resource<List<Noticia>?>> {
        ...
        val falhasDaWebApiEncontradas = MutableLiveData<Resource<List<Noticia>?>>();
        mediador.addSource(falhasDaWebApiEncontradas) { resourceDeFalha ->
        ...
        buscaNaApi(quandoFalha = { erro ->
            falhasDaWebApiEncontradas.value = Resource(dado = null, erro = erro)
        })
